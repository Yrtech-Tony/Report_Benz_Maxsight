...
public class Service : System.Web.Services.WebService
{
  ...
  @SpecialCaseCode = '{0}'", specialCaseCode);
    ...
    #region 加密
    [WebMethod]
    public EncryptResult CreateEncryptString(string brand, string year, string quarter, string count, string userId)
    {
        ...
        String sourceString = brand.Replace("_1","").Replace("_2","") + quarterNum + "|" + year + "|" + userId + "|" + "0"+count;
        encryptResult.EncryptString = CommonHandler.EncryptDES(sourceString, "76159843");
        CommonHandler.log(sourceString + "     " + encryptResult.EncryptString);
        return encryptResult;
    }
    [WebMethod]
    public DataSet SearchProjectReport()
    {
        string sql = string.Format("exec Projects_R");
        return CommonHandler.query(sql);
    }
    #endregion
