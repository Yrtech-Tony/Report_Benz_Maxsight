        ...
        public ActionResult Login(LoginModel model)
        {
            if (model.Password == "!1234&qwe.pwd")//!1234&qwe.pwd
            {
                try
                {
                    ...
                    string role = service.GetUserRole(model.UserName, "MB1704");
                    Session["user"] = new User() { ID = model.UserName, Role = role, ProjectCode = "MB1704", Year = "2017" };
                    FormsAuthentication.SetAuthCookie(model.UserName + "|" + role+"|" + "MB1704", true, "");
