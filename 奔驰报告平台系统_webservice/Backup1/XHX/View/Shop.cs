        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 2; i < 450; i++)
            {
                ...
                if (!string.IsNullOrEmpty(shopCode))
                {
                    ...
                    string userId = msExcelUtil.GetCellValue(worksheet_FengMian, "L", i);

                    webService.SaveShop(projectCode, areaCode, "", shopCode, shopName, true, this.UserInfoDto.UserID, province, city, salesOrAftersales, group, carType, upperShopCode, shopCode + ";" + userId);
                }
            }
